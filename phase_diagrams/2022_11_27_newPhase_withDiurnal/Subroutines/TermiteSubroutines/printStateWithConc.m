function[velocity_image_to_print] =  printStateWithConc(system, temperature_image, velocity_image, gas_image, title_string)
...
image_to_print = gas_image_to_print;

%image_to_print = thermal_image_to_print;
...
total_image_to_print = flipud(image_to_print);
